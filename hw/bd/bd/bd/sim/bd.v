...
(* CORE_GENERATION_INFO = "bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=16,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_bram_cntlr_cnt=1,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "bd.hwdef" *) 
module bd
   (clk_100mhz,
    ddr3_addr,
    ddr3_ba,
  ...
  wire [31:0]stats_accel_axil_0_bram_addr;
  wire stats_accel_axil_0_bram_clk;
  wire stats_accel_axil_0_bram_en;
  wire stats_accel_axil_0_bram_rst;
  wire [31:0]stats_accel_axil_0_bram_wdata;
  wire [3:0]stats_accel_axil_0_bram_we;
  wire sys_rst;
  wire uart_rxd;
  wire uart_txd;
  ...
  bd_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(stats_accel_axil_0_bram_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(stats_accel_axil_0_bram_clk),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(stats_accel_axil_0_bram_wdata),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(stats_accel_axil_0_bram_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(stats_accel_axil_0_bram_rst),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(stats_accel_axil_0_bram_we));
  ...
  bd_stats_accel_axil_0_0 stats_accel_axil_0
       (.bram_addr(stats_accel_axil_0_bram_addr),
        .bram_clk(stats_accel_axil_0_bram_clk),
        .bram_en(stats_accel_axil_0_bram_en),
        .bram_rdata(blk_mem_gen_0_doutb),
        .bram_rst(stats_accel_axil_0_bram_rst),
        .bram_wdata(stats_accel_axil_0_bram_wdata),
        .bram_we(stats_accel_axil_0_bram_we),
        .s_axi_aclk(mig_7series_0_ui_clk),
