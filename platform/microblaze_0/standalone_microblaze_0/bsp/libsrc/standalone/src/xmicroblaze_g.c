...
XMicroblaze_Config XMicroblaze_ConfigTable[] __attribute__ ((section (".drvcfg_sec"))) = {
	{
		0x1,  /* xlnx,unaligned-exceptions */
		 0,  /* xlnx,iopb-bus-exception */
		0x1,  /* xlnx,fpu-exception */
		0x0,  /* xlnx,fsl-exception */
		0x1,  /* xlnx,div-zero-exception */
		 0,  /* xlnx,dopb-bus-exception */
		0x1,  /* xlnx,ill-opcode-exception */
		...
		0x2,  /* xlnx,mmu-zones */
		0x2,  /* xlnx,number-of-pc-brk */
		0x1,  /* xlnx,number-of-rd-addr-brk */
		0x1,  /* xlnx,number-of-wr-addr-brk */
		0x1,  /* xlnx,opcode-0x0-illegal */
		0x2,  /* xlnx,pvr */
		 0,  /* xlnx,pvr-user1 */
		0x0,  /* xlnx,pvr-user2 */
		0x0,  /* xlnx,reset-msr */
